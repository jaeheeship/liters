...
function thumbImage($module_name,$sub_dir='tmp',$filename, $width=150, $height=100, $standard='width',$type='crop'){ 
    ...
    $ci->image_moo->load($filename)->resizeBy($width,$height,$standard)->save($thumbImage) ; 
